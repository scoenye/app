...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Caller.active'
        db.alter_column(u'caller', 'active', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):
        # Changing field 'Caller.active'
        db.alter_column(u'caller', 'active', self.gf('django.db.models.fields.NullBooleanField')(null=True))
