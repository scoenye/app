...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'WorkDone.technician' to match new field type.
        db.rename_column(u'work_done', u'technician', 'technician_id')
        # Changing field 'WorkDone.technician'
        db.alter_column(u'work_done', 'technician_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Technician']))

        # Renaming column for 'WorkDone.call' to match new field type.
        db.rename_column(u'work_done', u'call', 'call_id')
        # Changing field 'WorkDone.call'
        db.alter_column(u'work_done', 'call_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.HelpdeskCall']))

    def backwards(self, orm):

        # Renaming column for 'WorkDone.technician' to match new field type.
        db.rename_column(u'work_done', 'technician_id', u'technician')
        # Changing field 'WorkDone.technician'
        db.alter_column(u'work_done', u'technician', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Technician'], db_column=u'technician'))

        # Renaming column for 'WorkDone.call' to match new field type.
        db.rename_column(u'work_done', 'call_id', u'call')
        # Changing field 'WorkDone.call'
        db.alter_column(u'work_done', u'call', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.HelpdeskCall'], db_column=u'call'))
    ...
    models = {
        ...
        u'app.repaircall': {
            ...
            'close_tech': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'close_tech'", 'null': 'True', 'to': u"orm['app.Technician']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repair_tech': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.RepairTechnician']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'app.workdone': {
            ...
            'call': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.HelpdeskCall']"}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'technician': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Technician']"})
        }
    }
