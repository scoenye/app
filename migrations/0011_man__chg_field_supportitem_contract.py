...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'SupportItem.contract' to match new field type.
        db.rename_column(u'support_item', u'contract', 'contract_id')
        # Changing field 'SupportItem.contract'
        db.alter_column(u'support_item', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.MaintenanceContract'], null=True))

    def backwards(self, orm):
       # Renaming column for 'SupportItem.contract' to match new field type.
        db.rename_column(u'support_item', 'contract_id', u'contract')
        # Changing field 'SupportItem.contract'
        db.alter_column(u'support_item', u'contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.MaintenanceContract'], null=True, db_column=u'contract'))
