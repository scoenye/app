...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'RepairTechnician.company' to match new field type.
        db.rename_column(u'repair_technician', u'company', 'company_id')
        # Changing field 'RepairTechnician.company'
        db.alter_column(u'repair_technician', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Company'], null=True))

    def backwards(self, orm):

        # Renaming column for 'RepairTechnician.company' to match new field type.
        db.rename_column(u'repair_technician', 'company_id', u'company')
        # Changing field 'RepairTechnician.company'
        db.alter_column(u'repair_technician', u'company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Company'], null=True, db_column=u'company'))
