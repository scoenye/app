...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming the field 'OrderItem.item_type' to comply with Djang's _id postfix
        db.rename_column(u'order_item', u'item_type', u'item_type_id')

        # Renaming the field 'OrderItem.department' to comply with Djang's _id postfix
        db.rename_column(u'order_item', u'department', u'department_id')

        # Changing field 'OrderItem.mat_order'
        db.alter_column(u'order_item', 'mat_order_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.MaterialOrder']))

    def backwards(self, orm):
        # Revert the field 'OrderItem.item_type_id' back to its non-Django compliant name
        db.rename_column(u'order_item', u'item_type_id', u'item_type')

        # Revert the field 'OrderItem.department_id' back to its non-Django compliant name
        db.rename_column(u'order_item', u'department_id', u'department')

        # Changing field 'OrderItem.mat_order'
        db.alter_column(u'order_item', 'mat_order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.MaterialOrder'], null=True))
