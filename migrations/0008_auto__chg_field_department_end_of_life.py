...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Department.end_of_life'
        db.alter_column(u'department', 'end_of_life', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Department.end_of_life'
        db.alter_column(u'department', 'end_of_life', self.gf('django.db.models.fields.NullBooleanField')(null=True))
