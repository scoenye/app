...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'SerialNo.item' to match new field type.
        db.rename_column(u'serial_no', 'item', 'item_id')
        # Adding index on 'SerialNo', fields ['item']
        db.create_index(u'serial_no', ['item_id'])


    def backwards(self, orm):
        # Removing index on 'SerialNo', fields ['item']
        db.delete_index(u'serial_no', ['item_id'])

        # Renaming column for 'SerialNo.item' to match new field type.
        db.rename_column(u'serial_no', 'item_id', 'item')
