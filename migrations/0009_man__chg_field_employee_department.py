...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'Employee.department' to match new field type.
        db.rename_column(u'employee', u'department', 'department_id')
        # Changing field 'Employee.department'
        db.alter_column(u'employee', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.Department']))

    def backwards(self, orm):
        # Renaming column for 'Employee.department' to match new field type.
        db.rename_column(u'employee', 'department_id', u'department')
        # Changing field 'Employee.department'
        db.alter_column(u'employee', u'department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Department'], null=True, db_column=u'department'))
