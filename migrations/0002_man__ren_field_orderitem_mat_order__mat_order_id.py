...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'OrderItem.mat_order' to 'OrderItem.mat_order_id'
        db.rename_column(u'order_item', u'mat_order', u'mat_order_id')

    def backwards(self, orm):
        # Rename 'OrderItem.mat_order_id' back to 'OrderItem.mat_order'
        db.rename_column(u'order_item', u'mat_order_id', u'mat_order')
