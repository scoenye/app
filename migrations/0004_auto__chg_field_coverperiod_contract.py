...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'CoverPeriod.contract' to match new field type.
        db.rename_column(u'cover_period', u'contract', 'contract_id')
        # Changing field 'CoverPeriod.contract'
        db.alter_column(u'cover_period', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.MaintenanceContract']))

    def backwards(self, orm):

        # Renaming column for 'CoverPeriod.contract' to match new field type.
        db.rename_column(u'cover_period', 'contract_id', u'contract')
        # Changing field 'CoverPeriod.contract'
        db.alter_column(u'cover_period', u'contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.MaintenanceContract'], null=True, db_column=u'contract'))
