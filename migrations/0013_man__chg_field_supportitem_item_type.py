...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'SupportItem.item_type' to match new field type.
        db.rename_column(u'support_item', u'item_type', 'item_type_id')
        # Changing field 'SupportItem.item_type'
        db.alter_column(u'support_item', 'item_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.ItemType']))

    def backwards(self, orm):
        # Renaming column for 'SupportItem.item_type' to match new field type.
        db.rename_column(u'support_item', 'item_type_id', u'item_type')
        # Changing field 'SupportItem.item_type'
        db.alter_column(u'support_item', u'item_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.ItemType'], db_column=u'item_type'))
