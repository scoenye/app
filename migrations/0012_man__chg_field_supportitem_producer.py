...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'SupportItem.producer' to match new field type.
        db.rename_column(u'support_item', u'producer', 'producer_id')
        # Changing field 'SupportItem.producer'
        db.alter_column(u'support_item', 'producer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Company'], null=True))

    def backwards(self, orm):
         # Renaming column for 'SupportItem.producer' to match new field type.
        db.rename_column(u'support_item', 'producer_id', u'producer')
        # Changing field 'SupportItem.producer'
        db.alter_column(u'support_item', u'producer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Company'], null=True, db_column=u'producer'))
