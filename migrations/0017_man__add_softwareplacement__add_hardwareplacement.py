...
class Migration(SchemaMigration):
    ...
    # Just record the changes related to the HardwarePlacement and SoftwarePlacement additions.
    # These models only exist to stop Django from complaining about missing relationships.
