...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'SupportItem.order_item' to match new field type.
        db.rename_column(u'support_item', u'order_item', 'order_item_id')
        # Changing field 'SupportItem.order_item'
        db.alter_column(u'support_item', 'order_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.OrderItem'], null=True))

    def backwards(self, orm):
        # Renaming column for 'SupportItem.order_item' to match new field type.
        db.rename_column(u'support_item', 'order_item_id', u'order_item')
        # Changing field 'SupportItem.order_item'
        db.alter_column(u'support_item', u'order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.OrderItem'], null=True, db_column=u'order_item'))
