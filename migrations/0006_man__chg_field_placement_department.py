...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'Placement.department' to match new field type.
        db.rename_column(u'placement', u'department', 'department_id')
        
        # Changing field 'Placement.department'
        db.alter_column(u'placement', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['app.Department']))

        # Renaming column for 'Placement.item' to match new field type.
        db.rename_column(u'placement', 'item', 'item_id')
        
        # Changing field 'Placement.item' - FK is not real: inherited table
        db.alter_column(u'placement', 'item_id', self.gf('django.db.models.fields.related.IntegerField')(default=0))

        # Adding index on 'Placement', fields ['item']
        db.create_index(u'placement', ['item_id'])


    def backwards(self, orm):
        # Removing index on 'Placement', fields ['item']
        db.delete_index(u'placement', ['item_id'])

        # Renaming column for 'Placement.department' to match new field type.
        db.rename_column(u'placement', 'department_id', u'department')
        
        # Changing field 'Placement.department'
        db.alter_column(u'placement', u'department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Department'], null=True, db_column=u'department'))

        # Renaming column for 'Placement.item' to match new field type.
        db.rename_column(u'placement', 'item_id', 'item')
        
        # Changing field 'Placement.item'
        db.alter_column(u'placement', 'item', self.gf('django.db.models.fields.IntegerField')(null=True))
