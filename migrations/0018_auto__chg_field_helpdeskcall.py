...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'HelpdeskCall.closing_tech' to match new field type.
        db.rename_column(u'helpdesk_call', u'closing_tech', 'closing_tech_id')
        # Changing field 'HelpdeskCall.closing_tech'
        db.alter_column(u'helpdesk_call', 'closing_tech_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.Technician']))

        # Renaming column for 'HelpdeskCall.assigned_tech' to match new field type.
        db.rename_column(u'helpdesk_call', u'assigned_tech', 'assigned_tech_id')
        # Changing field 'HelpdeskCall.assigned_tech'
        db.alter_column(u'helpdesk_call', 'assigned_tech_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.Technician']))

        # Renaming column for 'HelpdeskCall.caller' to match new field type.
        db.rename_column(u'helpdesk_call', u'caller', 'caller_id')
        # Changing field 'HelpdeskCall.caller'
        db.alter_column(u'helpdesk_call', 'caller_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Caller'], null=True))

        # Renaming column for 'HelpdeskCall.item' to match new field type.
        db.rename_column(u'helpdesk_call', u'item', 'item_id')
        # Changing field 'HelpdeskCall.item'
        db.alter_column(u'helpdesk_call', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.SupportItem']))

        # Renaming column for 'HelpdeskCall.call_recorder' to match new field type.
        db.rename_column(u'helpdesk_call', u'call_recorder', 'call_recorder_id')
        # Changing field 'HelpdeskCall.call_recorder'
        db.alter_column(u'helpdesk_call', 'call_recorder_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.Technician']))

    def backwards(self, orm):

        # Renaming column for 'HelpdeskCall.closing_tech' to match new field type.
        db.rename_column(u'helpdesk_call', 'closing_tech_id', u'closing_tech')
        # Changing field 'HelpdeskCall.closing_tech'
        db.alter_column(u'helpdesk_call', u'closing_tech', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column=u'closing_tech', to=orm['app.Technician']))

        # Renaming column for 'HelpdeskCall.assigned_tech' to match new field type.
        db.rename_column(u'helpdesk_call', 'assigned_tech_id', u'assigned_tech')
        # Changing field 'HelpdeskCall.assigned_tech'
        db.alter_column(u'helpdesk_call', u'assigned_tech', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column=u'assigned_tech', to=orm['app.Technician']))

        # Renaming column for 'HelpdeskCall.caller' to match new field type.
        db.rename_column(u'helpdesk_call', 'caller_id', u'caller')
        # Changing field 'HelpdeskCall.caller'
        db.alter_column(u'helpdesk_call', u'caller', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Caller'], null=True, db_column=u'caller'))

        # Renaming column for 'HelpdeskCall.item' to match new field type.
        db.rename_column(u'helpdesk_call', 'item_id', u'item')
        # Changing field 'HelpdeskCall.item'
        db.alter_column(u'helpdesk_call', u'item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.SupportItem'], db_column=u'item'))

        # Renaming column for 'HelpdeskCall.call_recorder' to match new field type.
        db.rename_column(u'helpdesk_call', 'call_recorder_id', u'call_recorder')
        # Changing field 'HelpdeskCall.call_recorder'
        db.alter_column(u'helpdesk_call', u'call_recorder', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column=u'call_recorder', to=orm['app.Technician']))
    ...
    models = {
        ...
        u'app.helpdeskcall': {
            ...
            'assigned_tech': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'assigned_tech'", 'null': 'True', 'to': u"orm['app.Technician']"}),
            ...
            'closing_tech': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'closing_tech'", 'null': 'True', 'to': u"orm['app.Technician']"}),
